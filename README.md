...
The project consists of the development of a mobile application that generates a prediction based on an input value provided by the user. The implemented model is based on a simple linear equation of the form y=mx+b, specifically the equation y=2x−1.
Technical Stack
    ...
    Machine Learning Framework: TensorFlow Lite (a Google library designed for creating lightweight models for mobile integration).
